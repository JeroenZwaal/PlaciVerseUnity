...
namespace Assets.Code.ApiClient
{
    public class WebClient : MonoBehaviour
    {
        ...
        public async Awaitable<IWebRequestResponse> SendGetRequest(string route, Dictionary<string, string> headers)
        {
        ...
        public async Awaitable<IWebRequestResponse> SendPostRequest(string route, string data, Dictionary<string, string> headers)
        {
            UnityWebRequest webRequest = CreateWebRequest("POST", route, data);
        ...
        public async Awaitable<IWebRequestResponse> SendDeleteRequest(string route, Dictionary<string, string> headers)
        {
        ...
        private async Awaitable<IWebRequestResponse> SendWebRequest(UnityWebRequest webRequest)
        {
            ...
            switch (webRequest.result)
            {
                ...
                default:
                    return new WebRequestError(webRequest.downloadHandler.text);
            }
        }
